...
export function EditableText({
    ...
    if (isWhite == true) {
        return (
            <div
                ...
                {label && <div
                    className="text-sm font-semibold text-black uppercase tracking-wider mb-1 white-text">
                    {label}</div>}
                <div className="flex justify-between items-start gap-4">
                    <div
                        className={cn("flex-1 text-black whitespace-pre-wrap break-all pencil-flex white-text", textClassName)}>
                        {value || <span className="text-black/40 italic white-text">{placeholder}</span>}
                        <div
                            className="opacity-0 group-hover:opacity-100 transition-opacity text-black/50 hover:text-black white-text">
    ...
    return (
        <div
            ...
            onClick={() => setIsEditing(true)}>
            {label && <div
                className="text-sm font-semibold text-black uppercase tracking-wider mb-1">{label}</div>}
            <div className="flex justify-between items-start gap-4">
                <div
