            ...
            <div className="w-full">
                ...
                <form onSubmit={handleSubmit} className="create-quiz-form">
                    <div className="create-quiz-inputs">
                        <span className={"create-quiz-text"}>Quiz Title</span>
                        <Input
                            type="text"
                            value={title}
                            ...
                            required
                        />
                        <span className={"create-quiz-text"}>Description</span>
                        <Input
                            type="text"
                            value={description}
                    ...
                    <div className={"detail-inline"}>
                        <span className="create-quiz-text text-little-down">Questions</span>
                  ...
                  Question {qIndex + 1}
                                    ...
                                    {questions.length > 1 && (
                                        <Button
                                            ...
                                            className={"quiz-card-delete-button white-text"}
                                        >
                                            Remove
                                        </Button>
                                    )}
                    ...
                    <div className="create-button-group">
                        <Button
                            type="submit"
                            disabled={loading}
                            className="create-submit-button create-card-btn"
                            variant="primary"
                        >
